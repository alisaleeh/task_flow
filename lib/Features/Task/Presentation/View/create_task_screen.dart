        ...
        child: BlocConsumer<CreateTaskCubit, CreateTaskState>(
          listener: (context, state) {
            if (state is CreateTaskSuccess) {
              CustomSnackBar.showSuccess(context, 'created successfully');
              Navigator.pop(context, true); // العودة للشاشة الرئيسية بعد النجاح
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: state is CreateTaskLoading
                                ? null
                                : _onSavePressed,
